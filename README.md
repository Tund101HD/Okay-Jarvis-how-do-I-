...
| :--- | :--- | :---: | :---: | :---: |
| [**Assemble in CLion**](./guides/clion-nasm.md) | How to set up CLion to play around with NASM assembly without losing your mind. | `CLion` `NASM` | 29/04/2026 | ![](https://img.shields.io/badge/ASM-blue?style=for-the-badge) ![](https://img.shields.io/badge/SETUP-orange?style=for-the-badge) |
| [**The WSL Parallel**](./guides/clion-wsl.md) | Setting up CLion to work seamlessly with WSL in parallel. | `CLion` `WSL2` | 29/04/2026 | ![](https://img.shields.io/badge/WSL-green?style=for-the-badge) ![](https://img.shields.io/badge/SETUP-orange?style=for-the-badge) |
